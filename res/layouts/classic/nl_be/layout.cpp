...
static const std::vector<KeyTranslationEntry> g_flemishClassic = {
    ...
    { Key::Comma, true, false, false, { { Key::Comma, true, false, false } }, std::string(), true, CapsLock::Active },
    { Key::Dot, false, false, false, { { Key::Dot, false, false, false } }, std::string(), true, CapsLock::Inactive },
    { Key::Dot, true, false, false, { { Key::Dot, true, false, false } }, std::string(), false, CapsLock::Inactive },
    { Key::Dot, false, false, false, { { Key::Dot, false, false, false } }, std::string(), false, CapsLock::Active },
    { Key::Dot, true, false, false, { { Key::Dot, true, false, false } }, std::string(), true, CapsLock::Active },
